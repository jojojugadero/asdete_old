...
if($sesion != ''){
    ...
    if($sesion == 'afiliado_session'){
        ...
        $ses_desc .= "<br><p class='user-login'><strong>Desconectar:</strong>  <a title='Haz click para cerrar sesión' href ='".$dirRoot."POO/VISTA/index.php?tipologin=afil&swlogout=S'><img class='user-logout' src='".$dirRoot."POO/VISTA/IMAGENES/logout_afil.png'></a></p>";
