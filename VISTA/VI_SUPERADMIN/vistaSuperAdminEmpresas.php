...
include $incRoot.'CONTROLADOR/CO_SUPERADMIN/appSuperAdminEmpresas.php';
...
<form name="formTabla" id="formTabla" href="<?php echo $dirRoot; ?>VISTA/VI_SUPERADMIN/vistaSuperAdminEmpresas.php" method="post">
