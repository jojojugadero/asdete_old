...
include $incRoot.'MODELO/MO_SUPERADMIN/includesSuperAdmin.php';

include $incRoot.'CONTROLADOR/CO_SUPERADMIN/appSuperAdminAdministradores.php';
...
<nav class="navega<?php echo $sufijo_estilo; ?>"><p style="font-size:large;">Empresas del sector</p>
 ...
 <aside class="barra<?php echo $sufijo_estilo; ?>"><p style="font-size:large;">Contactos</p>
    ...
    <a href="<?php echo $dirRoot; ?>VISTA/index.php?tipologin=sadmin">Indice</a> > <a href="<?php echo $dirRoot; ?>VISTA/VI_SUPERADMIN/vistaSuperAdminMenu.php">Menú</a>
    
    <!--Formulario para realizar todas las operaciones de base de datos-->
<form name="formTabla" id="formTabla" href="<?php echo $dirRoot; ?>VISTA/VI_SUPERADMIN/vistaSuperAdminAdministradores.php" method="post">
