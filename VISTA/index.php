                ...
                <div class="row">
                    ...
                    <?php if($tipologin == 'afil'){?>
                        <div class="login-formulario1">
                            ...
                            <form action="<?php echo $dirRoot; ?>CONTROLADOR/CO_AFILIADOS/logCompruebaAfiliados.php" method="POST" >
                    ...
                    <?php } else if($tipologin == 'admin') {?>
                        <div class="login-formulario2">
                            ...
                            <!--Formulario que enviará datos para comprobar que el usuario y password estan correctos en base de datos -->
                            <form action="<?php echo $dirRoot; ?>CONTROLADOR/CO_ADMINISTRADORES/logCompruebaAdmin.php" method="POST" >
                                <div class="form-group">
                    ...
                    <?php } else if($tipologin == 'sadmin') {?>
                        <div class="login-formulario3">
                            ...
                            <!--Formulario que enviará datos para comprobar que el usuario y password estan correctos en base de datos -->
                            <form action="<?php echo $dirRoot; ?>CONTROLADOR/CO_SUPERADMIN/logCompruebaSuperAdmin.php" method="POST" >
                                <div class="form-group">
