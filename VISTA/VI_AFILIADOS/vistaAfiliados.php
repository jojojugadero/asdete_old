...
include $incRoot.'CONTROLADOR/CO_AFILIADOS/appAfiliado.php';
...
<body class="cuerpo_contenedor<?php echo $sufijo_estilo; ?>" >
    ...
    <a href="<?php echo $dirRoot; ?>VISTA/index.php?tipologin=afil">Indice</a>
    </span>
...
<form name="saludoAfiliado" id="saludoAfiliado" action="<?php echo $dirRoot ?>CONTROLADOR/convenios.php" method="post">
<div>
