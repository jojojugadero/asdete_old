...
include $incRoot.'CONTROLADOR/ControlCabecera.php';
?>

<table width="100%">
    <tr>
        <td width="20%">
            <a href="<?php echo $dirRoot; ?>VISTA/index.php" title="Volver a inicio"><img src="<?php echo $dirRoot; ?>VISTA/IMAGENES/banner.png" alt="Banner" width="400" height="80"/></a>
        </td>
