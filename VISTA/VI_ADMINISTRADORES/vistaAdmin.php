...
include $incRoot.'CONTROLADOR/CO_ADMINISTRADORES/appAdministra.php';
...
<form name="formTabla" id="formTabla" action="<?php echo $dirRoot; ?>VISTA/VI_ADMINISTRADORES/vistaAdmin.php" method="post">
