...
<li class='li_sidebar'><a href='<?php echo $dirRoot; ?>'MVC_TOCAR\VISTA\VI_UTILS\calendarios.php' class='enlace_sidebar'>Calendarios laborales</a></li>
<li class='li_sidebar'><a href='<?php echo $dirRoot; ?>'MVC_TOCAR\VISTA\VI_UTILS\empleo.php' class='enlace_sidebar'>Tu empleo</a></li>
<li class='li_sidebar'><a href='<?php echo $dirRoot; ?>'MVC_TOCAR\VISTA\VI_UTILS\formacion.php' class='enlace_sidebar'>Forma T</a></li>
<li class='li_sidebar'><a href='<?php echo $dirRoot; ?>'MVC_TOCAR\VISTA\VI_UTILS\prestamos.php' class='enlace_sidebar'>Empresa 4</a></li>
<li class='li_sidebar'><a href='<?php echo $dirRoot; ?>'MVC_TOCAR\VISTA\VI_UTILS\afiliacion.php' class='enlace_sidebar'>Empresa 5</a></li>
