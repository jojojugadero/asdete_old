...
if(isset($_SESSION['personal_sesion']) == 'personal_sesion') {
    $url1 ="ASDETE\VISTA\ADMINISTRADORES\appAdmin.php";
    header('Location: '.$url1);
  } else {
    $url2 ="C:\Users\Usuario\www\asdete\ASDETE\VISTA\index.php";
...
<body class="cuerpo_contenedor" >
   ...
   <ul >
    ...
    <a href="ASDETE\VISTA\index.php">Indice</a> > <a href="ASDETE\VISTA\ADMINISTRADORES\adminLogin.php">Login</a>
    
    <!––Formulario para realizar todas las operaciones de base de datos––>
<form name="formTabla" id="formTabla" href="ASDETE\VISTA\AFILIADOS\appAfiliados.php" method="post">
